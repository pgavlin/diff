...
func diffSize[S text.String](t testing.TB, edits []diff.Edit[S]) int {
...
func benchmarkDiff[S text.String](b *testing.B, t1, t2 S) {
...
func benchmarkDiffCore[S text.String](b *testing.B, t1, t2 S) {
